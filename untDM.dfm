object DM: TDM
  ...
  object CONEXAO: TFDConnection
    Params.Strings = (
        ...
        'Database=C:\Users\Geovani\Desktop\pet sistem\Documentos\BANCO.FD' +
        'B'
      'User_Name=SYSDBA'
      'Password=masterkey'
      'DriverID=FB')
  ...
  object qryItemVenda: TFDQuery
    ...
    object qryItemVendaCOD_ITEN: TIntegerField
      FieldName = 'COD_ITEN'
      Origin = 'COD_ITEN'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
  ...
  object qryVenda: TFDQuery
    ...
    Left = 128
    Top = 80
    object qryVendaID_VEN: TIntegerField
      FieldName = 'ID_VEN'
      Origin = 'ID_VEN'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    ...
    object qryVendaVALOR_VEN: TBCDField
      FieldName = 'VALOR_VEN'
      Origin = 'VALOR_VEN'
      Precision = 18
      Size = 2
    end
    object qryVendaDATA_VEN: TDateField
      FieldName = 'DATA_VEN'
      Origin = 'DATA_VEN'
    end
    object qryVendaSITUACAO: TIntegerField
      FieldName = 'SITUACAO'
      Origin = 'SITUACAO'
    end
    object qryVendaID_FUN: TIntegerField
      FieldName = 'ID_FUN'
      Origin = 'ID_FUN'
    end
    object qryVendaTOTAL: TCurrencyField
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
    end
    object qryVendaSUB_TOTAL: TCurrencyField
      FieldName = 'SUB_TOTAL'
      Origin = 'SUB_TOTAL'
    end
    object qryVendaQUANTIDADE: TCurrencyField
      FieldName = 'QUANTIDADE'
      Origin = 'QUANTIDADE'
    end
    object qryVendaVLR_UNIT: TCurrencyField
      FieldName = 'VLR_UNIT'
      Origin = 'VLR_UNIT'
    end
  end
