...
uses
  ...
  Vcl.StdCtrls, Vcl.ExtCtrls, frxClass, frxDBSet, Vcl.DBCtrls;
...
procedure TfrmPesqCidade.cbCampoPesqClick(Sender: TObject);
begin
...
procedure TfrmPesqCidade.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  IF Key = Vk_Escape then frmPesqCidade.Close;
end;
